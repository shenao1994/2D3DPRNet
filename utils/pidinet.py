...
from utils.ops import Conv2d
from utils.config import config_model, config_model_converted
...
class PiDiNet(nn.Module):
    def __init__(self, inplane, pdcs, dil=None, sa=False, convert=False):
        ...
        if convert:
            ...
            self.init_block = Conv2d(pdcs[0], 1, self.inplane, kernel_size=3, padding=1)
